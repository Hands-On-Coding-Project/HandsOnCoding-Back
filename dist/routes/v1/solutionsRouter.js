...
router.route("/").get((req, res) => {
    (0, solutionsService_1.getSolutions)()
        .then((v) => {
        res.status(200);
        res.send(v);
    })
...
router.route("/:id").get((req, res) => {
    (0, solutionsService_1.getSolution)(req.params.id)
        .then((v) => {
        if (!v) {
            res.status(404);
            const error = {
...
router.route("/").post((req, res) => {
    (0, solutionsService_1.createSolution)(req.body)
        .then((v) => {
        res.status(201);
        res.send(v);
    })
...
router.route("/:id").put((req, res) => {
    (0, solutionsService_1.updateSolution)(req.params.id, req.body)
        .then((v) => {
        res.status(200);
        res.send(v);
    })
...
router.route("/:id").delete((req, res) => {
    (0, solutionsService_1.deleteSolution)(req.params.id)
        .then((v) => {
        res.status(200);
        res.send(v);
    })
...
//# sourceMappingURL=solutionsRouter.js.map